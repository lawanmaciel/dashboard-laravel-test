<div>
    <x-detail-page title="Produtos" subtitle="Gerencie os produtos registrados." />
    <div class="content">
                ...
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content block-content-full text-end bg-body">
                        ...
                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal"
                            wire:click="saveProduct()">Salvar</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content fs-sm mb-3">
                        <input type="text" class="form-control mb-3" placeholder="Digite algo..."
                            wire:model="productEdit">
                    </div>
                    <div class="block-content block-content-full text-end bg-body">
                        <button type="button" class="btn btn-sm btn-alt-secondary me-1"
                            data-bs-dismiss="modal">Cancelar</button>
                        <button type="button" class="btn btn-sm btn-danger" data-bs-dismiss="modal"
                            wire:click="editProduct()">Salvar</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content block-content-full text-end bg-body">
                        <button type="button" class="btn btn-sm btn-alt-secondary me-1"
                            data-bs-dismiss="modal">Cancelar</button>
                        <button type="button" class="btn btn-sm btn-danger" data-bs-dismiss="modal"
                            wire:click="deleteProduct()">Deletar</button>
                    </div>
                </div>
            </div>
        </div>
